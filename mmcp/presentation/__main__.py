...
Entry point with subcommands:
    context-life              ΓåÆ start MCP server (stdio)
    context-life serve        ΓåÆ start MCP server (stdio)
    context-life serve --http ΓåÆ start MCP server (HTTP)
    context-life tui          ΓåÆ open the stateful terminal menu (Config / Metrics)
    context-life info         ΓåÆ show system info + config
    context-life doctor       ΓåÆ run environment diagnostics
    context-life warmup interactive ΓåÆ choose warmup mode interactively
    context-life upgrade      ΓåÆ upgrade to latest GitHub release
    context-life upgrade --version <tag> ΓåÆ install specific version
    context-life upgrade --dry-run      ΓåÆ check without installing
    context-life version      ΓåÆ show version
    context-life help         ΓåÆ show help
    python -m mmcp            ΓåÆ from source (same behavior)
"""
...
def main():
    ...
    # No args ΓåÆ default MCP server (stdio)
